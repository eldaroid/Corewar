...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/01 18:14:02 by dmetallo          #+#    #+#             */
/*   Updated: 2020/12/01 18:14:04 by dmetallo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (c == 'r')
		i_ams->code_arg |= (REG_CODE << num);
	else if (c == '%')
		i_ams->code_arg |= (DIR_CODE << num);
	else if (is_num(c) || c == ':')
		i_ams->code_arg |= (IND_CODE << num);
}
