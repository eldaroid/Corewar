...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/01 17:59:56 by dmetallo          #+#    #+#             */
/*   Updated: 2020/12/01 17:59:57 by dmetallo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			code_instr(t_com *commands, t_main *str_asm);
...
void			assembler(t_com *commands, t_ch player,
					t_main *str_asm);
#endif
